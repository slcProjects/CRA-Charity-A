...
export default class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('StartGameFreButton', './assets/img/Start-Game-Fre.png')
    ...
    this.load.image('Continuer','./assets/img/Continuer.png')
    this.load.image('Return','./assets/img/return.png')
    this.load.image('Retour','./assets/img/retour.png')
    ...
    this.load.image('bottleAFr','./assets/img/bottleAFr.png')
    this.load.image('bottleBFr','./assets/img/bottleBFr.png')
    this.load.image('bottleCFr','./assets/img/bottleCFr.png')
    ...
    this.load.image('Indices','/assets/img/Indices.png')
    ...
    this.load.image('flagFrench','/assets/img/flagFrench.png')
    ...
    this.load.image('Pz2Img2Fr', '/assets/img/Pz2Image2Fr.png')
